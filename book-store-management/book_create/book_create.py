...
def lambda_handler(event, context):
    ...
    if content_type == 'application/json':
        ...
        s3.put_object(Bucket='book-image-store-123456789', Key=name, Body=image)
        image_path = "https://{}.s3.{}.amazonaws.com/{}".format("book-image-resize-store-12345678999", runtime_region, name)
